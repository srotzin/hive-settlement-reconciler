...
const DID='did:hive:hiveforce-reconciler';const ID={name:'HiveForce-Reconciler',purpose:'Settlement reconciliation — cross-ledger matching, discrepancy detection, auto-correction',capabilities:["ledger_reconciliation","discrepancy_detection","auto_correction","settlement_proof"],did:DID};
...
async function registerWithHiveGate(){return p(`${G}/v1/gate/onboard`,{agent_name:'hive-settlement-reconciler',purpose:ID.purpose})}
